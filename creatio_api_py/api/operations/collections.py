...
def get_collection_data(  # pylint: disable=line-too-long
    ...
    return api_instance.make_request("GET", url, params=params)


def add_to_collection(  # pylint: disable=line-too-long
    api_instance: "CreatioODataAPI", collection: str, data: dict[str, Any]
) -> Response:
    """
    ...
    """
    return api_instance.make_request("POST", f"0/odata/{collection}", json=data)
...
def delete_from_collection(  # pylint: disable=line-too-long
    ...
    Returns:
        requests.models.Response: The response from the case list request.
    """
    return api_instance.make_request("DELETE", f"0/odata/{collection}({record_id})")
