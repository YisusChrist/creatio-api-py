...
def _update_cookies_file(
    api_instance: "CreatioODataAPI", cookies_data: dict[str, dict[str, Any]]
) -> None:
...
def load_session_cookie(api_instance: "CreatioODataAPI", username: str) -> bool:
    """
...
def store_session_cookie(api_instance: "CreatioODataAPI", username: str) -> None:
    """
